document.addEventListener("DOMContentLoaded", function () {
    ...
    function typeTextEffect(text, speed = 40, callback) {
        ...
        terminalText.innerHTML = ""; // Clear existing text
        type();
    }

    // Terminal startup text (with escaped backticks)
    const introText = `
               _,.,  °             ,.  '                ,.  '             ,.-·.            , ·. ,.-·~·.,   ‘             ,  . .,  °             ,  . .,  °                       
        ,.·'´  ,. ,  \`;\\ '         /   ';\\              /   ';\\            /    ;'\\'         /  ·'´,.-·-.,   \`,'‚       ;'´    ,   ., _';\\'     ;'´    ,   ., _';\\'                     
      .´   ;´:::::\\\`'´ \\'\\       ,'   ,'::'\\           ,'   ,'::'\\          ;    ;:::\\       /  .'´\\:::::::'\\   '\\ °     \\:´¨¯:;'   \`;::'\\:'\\    \\:´¨¯:;'   \`;::'\\:'\\                    
...
███████████████████████████████████████████████████████
Welcome to the Museum of Xenodemonolody.
This terminal holds the archive of Elliott Higgs, Curator, Writer and Researcher
The archive is corrupted, but some fragments remain accessible.
...
`;
    ...
    function processCommand(command) {
        switch (command) {
            ...
            case "look exhibitions":
                ...
                break;
            case "shutdown":
                alert("System shutting down..."); // Replace with a better action
                break;
            default:
    ...
    // Define the missing typeText function
